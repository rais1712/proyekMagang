// File: app/src/main/java/com/proyek/maganggsp/presentation/adapters/SearchAdapter.kt - UPDATED MODULAR
...
/**
 * MODULAR: Search adapter using modular utilities
...
class SearchAdapter(
    ...
    class SearchResultViewHolder(
        ...
        fun bind(receipt: Receipt, query: String) {
            with(binding) {
                ...
                tvNomorLoket.text = highlightSearchMatch(receipt.getDisplayPpid(), query)
                ...
                root.setOnClickListener {
                    LoggingUtils.logDebug("SearchAdapter", "Search result clicked: ${receipt.ppid}")
    ...
    fun updateSearchResults(results: List<Receipt>, query: String) {
        searchQuery = query
        submitList(results)
        LoggingUtils.logDebug(TAG, "Search results updated: ${results.size} results for '$query'")
    }
